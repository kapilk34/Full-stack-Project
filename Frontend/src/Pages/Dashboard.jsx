...
import {
  BarChart3, ShoppingBag, TrendingUp, Users,
  Activity, Bell, Settings, HelpCircle, LogOut, Menu
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden flex justify-between items-center p-4 border-b shadow-sm">
        ...
        <button onClick={() => setSidebarOpen(!sidebarOpen)} className="p-2 rounded-md text-gray-700 hover:bg-gray-100">
          <Menu size={24} />
        </button>
      </div>

      {/* Sidebar */}
      <div className={`fixed lg:static z-20 top-0 left-0 h-full w-64 bg-white border-r shadow-lg transition-transform duration-300 ease-in-out
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="p-4">
            ...
            <CardContent>
              <LineChart
                ...
                series={[{ data: monthlyRevenue, label: 'Revenue ($)', color: '#3b82f6' }]}
                height={300}
              />
            </CardContent>
          </Card>
          <Card className="p-4">
            ...
            <CardContent>
              <BarChart
                xAxis={[{ data: Array.from({ length: 12 }, (_, i) => i + 1), scaleType: 'band' }]}
                series={[{ data: userGrowth, label: 'Users', color: '#10b981' }]}
                height={300}
              />
            </CardContent>
          </Card>
          ...
          <Card className="p-4">
            ...
            <CardContent>
              <BarChart
                ...
                series={[{ data: Object.values(trafficSources), label: 'Traffic (%)', color: '#8b5cf6' }]}
                height={300}
              />
            </CardContent>
          </Card>
