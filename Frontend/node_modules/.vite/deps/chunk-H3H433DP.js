...
var Typography = React34.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var SvgIcon = React41.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime25.jsx)(SvgIcon_default, {
...
function useControlled(props) {
  ...
  } = React44.useRef(controlled !== void 0);
  const [valueState, setValue] = React44.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React44.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useLazyRef(init, initArg) {
  const ref = React46.useRef(UNINITIALIZED);
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React47.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React47.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
var IconButton = React59.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiIconButton"
  });
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types39.default.node, (props) => {
    const found = React59.Children.toArray(props.children).some((child) => React59.isValidElement(child) && child.props.onClick);
    if (found) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H3H433DP.js.map
